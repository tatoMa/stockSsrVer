<template>
  <v-app>
    ...
    <!--the main page-->
    <v-content>
      <!--section one the parallels image-->
      <section>
        <v-parallax :src="require('@/assets/hero.jpg')" height="300">
          <v-layout
            column
            align-center
            justify-center
                  ...
                  <v-card>
                    ...
                    <v-card-title primary-title>
                      <v-flex>
                        ...
                        <!--all buttons and functions of the stock chart-->
                        <div>
      ...
      <!--section 4 the company information-->
      <section>
        <v-container grid-list-xl>
...
export default {
  ...
  methods: {
    ...
    // calculator the max profit based on the data provided
    maxProfitCalculator () {
      this.maxProfit = this.getMaxProfit(this.stockPricesYesterday)
    },

    // the method of calculation of get max profit
    getMaxProfit (arr) {
      var minIdx = 0
      var maxIdx = 1
      var currMin = 0
    ...
    // showing the stock chart and display it on screen
    showStockChart () {
  ...
  watch: {
    ...
    // when company selection changed, aotu call the function to re-calculate the max profit
  ...
  mounted () {
    ...
    // call to display stock after page mounted
    this.showStockChart()
  },
  created () {
  }
